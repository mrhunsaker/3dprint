---
title: "Unibody Switch"
sku: "PRT-00063-OT-SLP"
description: "Single-body adaptive switch housing for durable access and activation training"
categories:
...
tags:
  ...
  - therapy
header:
  teaser: /assets/images/prints/UnibodySwitch.jpeg
stl: /assets/files/LINK TO 3D PRINT FILE(s).stl
---

![Unibody Switch - View 1](/assets/images/prints/UnibodySwitch.jpeg){: .full style="max-width: 600px;"}
![Unibody Switch - View 2](/assets/images/prints/UnibodySwitch-2.jpeg){: .full style="max-width: 600px;"}

The Unibody Switch uses a single-piece housing style to provide a stable form factor for repeated use in access training activities. It can be integrated with AAC devices, adapted toys, and other switch-compatible interfaces to support communication and participation goals. The design is suitable for occupational therapy and speech-language sessions that focus on consistent switch activation.

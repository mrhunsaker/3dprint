---
title: "Rocker Switch"
sku: "PRT-00059-OT-SLP"
description: "Large-surface adaptive rocker switch for alternative access"
categories:
...
tags:
  ...
  - motor-access
header:
  teaser: /assets/images/prints/RockerSwitch.JPEG
stl: /assets/files/LINK TO 3D PRINT FILE(s).stl
---

![Rocker Switch](/assets/images/prints/RockerSwitch.JPEG){: .full style="max-width: 600px;"}

The Rocker Switch provides a broad activation surface that can be pressed from multiple hand positions, making it a practical option for learners and clients who need reduced precision demands. It can be paired with communication devices, adapted toys, or computer access interfaces to support participation in speech-language activities and occupational therapy interventions. The shape and travel are intended to encourage successful switch use with repeatable feedback.

...
sku: "PRT-00060-OT-SLP"
description: "Multi-view adaptive interaction switch for therapy and communication access"
categories:
...
tags:
  ...
  - therapy
header:
  teaser: /assets/images/prints/InteractSwitch.JPEG
stl: /assets/files/LINK TO 3D PRINT FILE(s).stl
---

![Interact Switch - View 1](/assets/images/prints/InteractSwitch.JPEG){: .full style="max-width: 600px;"}
![Interact Switch - View 2](/assets/images/prints/InteractSwitch-2.JPEG){: .full style="max-width: 600px;"}
![Interact Switch - View 3](/assets/images/prints/InteractSwitch-3.JPEG){: .full style="max-width: 600px;"}
![Interact Switch - View 4](/assets/images/prints/InteractSwitch-4.JPEG){: .full style="max-width: 600px;"}

The Interact Switch is an adaptive access switch system designed for repeated activation tasks in learning, communication, and functional activity practice. Multiple build views are shown to highlight enclosure details and switch geometry for different mounting and positioning setups. This model can support switch training, cause-and-effect instruction, and AAC access goals across occupational therapy and speech-language intervention contexts.

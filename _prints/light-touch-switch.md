...
sku: "PRT-00061-OT-SLP"
description: "Low-force adaptive switch for accessible activation in therapy and communication"
categories:
...
tags:
  ...
  - low-force
header:
  teaser: /assets/images/prints/LightTouchSwitch.jpeg
stl: /assets/files/LINK TO 3D PRINT FILE(s).stl
---

![Light Touch Switch - View 1](/assets/images/prints/LightTouchSwitch.jpeg){: .full style="max-width: 600px;"}
![Light Touch Switch - View 2](/assets/images/prints/LightTouchSwitch-2.jpeg){: .full style="max-width: 600px;"}

The Light Touch Switch is designed for users who benefit from reduced activation force during switch-access tasks. Its form supports repeatable, gentle presses for cause-and-effect learning, AAC access, and computer or toy interface control. This print can be used in both occupational therapy and speech-language sessions to promote reliable activation with less motor demand.

---
title: "MMC60"
sku: "PRT-00058-OT-SLP"
description: "Compact 60mm adaptive switch housing for accessible input access"
categories:
...
tags:
  ...
  - therapy
header:
  teaser: /assets/images/prints/MMC60.jpg
stl: /assets/files/LINK TO 3D PRINT FILE(s).stl
---

![MMC60 Adaptive Switch](/assets/images/prints/MMC60.jpg){: .full style="max-width: 600px;"}

The MMC60 is a compact adaptive switch enclosure designed to provide reliable, low-force activation for users who need alternative access methods. Its 60mm form factor is easy to position on desks, wheelchairs, or therapy workstations, making it useful for cause-and-effect activities, computer access, and AAC partner-assisted communication tasks. The design supports consistent switch targeting practice while remaining durable enough for repeated clinical and classroom use.

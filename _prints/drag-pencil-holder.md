---
title: "Drag Pencil Holder"
sku: "PRT-00055-OT"
description: "Adaptive pencil holder with drag-style grip for improved writing control"
categories:
...
tags:
  ...
  - education
header:
  teaser: /assets/images/prints/drag-pencil-holder.jpeg
stl: /assets/files/LINK TO 3D PRINT FILE(s).stl
---

![Drag Pencil Holder](/assets/images/prints/drag-pencil-holder.jpeg){: .full style="max-width: 600px;"}
![Drag Pencil Holder - View 2](/assets/images/prints/drag-pencil-holder-2.jpeg){: .full style="max-width: 600px;"}

A 3D-printed adaptive pencil holder featuring a drag-style grip design that positions the writing instrument at an optimal angle while reducing the fine motor demand of maintaining a traditional pencil grasp. This tool helps individuals with limited hand strength, coordination, or dexterity produce more controlled handwriting with less fatigue, making it a valuable resource for occupational therapy programs focused on writing readiness and classroom participation.

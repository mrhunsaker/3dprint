...
sku: "PRT-00062-OT-SLP"
description: "Adaptive switch with contoured top for reliable alternative access input"
categories:
...
tags:
  ...
  - motor-access
header:
  teaser: /assets/images/prints/RaindropSwitch.jpeg
stl: /assets/files/LINK TO 3D PRINT FILE(s).stl
---

![Raindrop Switch - View 1](/assets/images/prints/RaindropSwitch.jpeg){: .full style="max-width: 600px;"}
![Raindrop Switch - View 2](/assets/images/prints/RaindropSwitch-2.jpeg){: .full style="max-width: 600px;"}

The Raindrop Switch features a rounded, contoured profile intended to support comfortable activation from different hand positions. It is suited for switch-access practice, communication-device input, and adapted activity control where consistent activation feedback is important. This model can support intervention goals in occupational therapy and speech-language pathology settings.

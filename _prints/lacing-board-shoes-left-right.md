---
title: "Lacing Board Shoes Left Right"
sku: "PRT-00054-OT"
description: "Left and right shoe lacing boards for teaching shoe-tying skills"
categories:
...
tags:
  ...
  - education
header:
  teaser: /assets/images/prints/lacing-board-shoes-left-right.jpeg
stl: /assets/files/LINK TO 3D PRINT FILE(s).stl
---

![Lacing Board Shoes Left Right](/assets/images/prints/lacing-board-shoes-left-right.jpeg){: .full style="max-width: 600px;"}

A 3D-printed lacing board set featuring left and right shoe shapes with lace holes, designed to teach shoe-tying and lacing skills. These boards provide a stable, oversized practice surface that helps students develop the bilateral coordination, fine motor dexterity, and sequential steps needed to independently tie their shoes. Ideal for occupational therapy programs focused on daily living skills and self-care independence.

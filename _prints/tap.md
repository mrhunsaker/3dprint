---
title: "Tap+"
sku: "PRT-00064-OT-SLP"
description: "Bluetooth dual switch assistive device for accessible control of phones, tablets, and computers"
categories:
...
tags:
  ...
  - microbit
header:
  teaser: /assets/images/prints/Tap+.jpeg
stl: /assets/files/LINK TO 3D PRINT FILE(s).stl
---

![Tap+ - View 1](/assets/images/prints/Tap+.jpeg){: .full style="max-width: 600px;"}

Tap+ is an open-source Bluetooth dual switch access device that helps users with disabilities control phones, tablets, and computers through standard switch-control workflows. Built around a micro:bit v2, it supports customizable button mapping for actions such as next, select, play, pause, and other input behaviors used in communication and participation activities. The design is intended for rapid fabrication and personalization, making it well suited for occupational therapy and speech-language practice focused on switch access, AAC interaction, and functional device use.

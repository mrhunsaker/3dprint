...
Welcome to the puppet-making resource page! Here you'll find patterns, materials lists, and step-by-step photo instructions for building **Snoof Puppets** and **Glove Puppets**. These puppets are great for classroom use, storytelling, and creative expression.

---

## Video Tutorial

Most of my methods and ideas came from this video, which is worth it for the dad jokes if nothing else. 

<div style="position:relative; padding-bottom:56.25%; height:0; overflow:hidden; max-width:100%; margin-bottom:2rem;">
  <iframe style="position:absolute; top:0; left:0; width:100%; height:100%;"
          src="https://www.youtube.com/embed/G5ERmXdUhvs"
          title="Adam Savage Builds a MONSTER (Puppet)"
          frameborder="0"
...
- **From Amazon:**
    - FabricLA Shaggy Faux Fur Square - 15" X 15" Precut. Comes in almost every color you woudl ever want
    ...
    - Geyoga 12 Pairs Women Triangle Bra Insert Removable Sports Bra Pads Inserts Women Replacement Pad
    - Any type of Utility knife with Retractable Snap-Off Blade
    - Any type of Cut Resistant Gloves (since you WILL be cutting with razor blades rather than scissors)
    - Scissors for cutting thread and trimming felt. 
    - Choose Whichever Colored 12–20mm Safety Eyes you like in color of your choice
- **From Wawak:**
...
#### Step 2 — Set Up for Sewing

Thread your needle with polyester thread and have your sewing clips within reach. Arrange all cut pieces in order so assembly goes smoothly.
...
![Snoof mouth piece partially sewn together](/assets/images/puppets/snoof-mouth-half-sewn.jpeg)
...
![Small glove puppet with eye placement layout shown](/assets/images/puppets/small-glove-puppet-eye-layout.jpeg)
